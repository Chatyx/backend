...
func TestGroupParticipant_List(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			service := NewGroupParticipant(repo)
...
func TestGroupParticipant_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			currentUserID: 1,
			mockBehavior: func(repo *MockGroupParticipantRepository) {
				repo.On("Get", mock.Anything, 1, 1).Return(entity.GroupParticipant{
					GroupID: 1,
					UserID:  1,
					IsAdmin: true,
					Status:  entity.JoinedStatus,
				...
				repo.On("Get", mock.Anything, 1, 2).Return(defaultParticipant, nil)
			},
		...
		},
		{
			...
			mockBehavior: func(repo *MockGroupParticipantRepository) {
				...
				repo.On("Get", mock.Anything, 1, 2).Return(entity.GroupParticipant{}, entity.ErrGroupParticipantNotFound)
			},
		...
		},
		{
			...
			currentUserID: 1,
			mockBehavior: func(repo *MockGroupParticipantRepository) {
				repo.On("Get", mock.Anything, 1, 1).Return(entity.GroupParticipant{}, entity.ErrGroupParticipantNotFound)
			},
			expectedError: entity.ErrGroupNotFound,
		},
		{
		...
		},
		{
			...
			currentUserID: 1,
			mockBehavior: func(repo *MockGroupParticipantRepository) {
				repo.On("Get", mock.Anything, 1, 1).Return(entity.GroupParticipant{}, errUnexpected)
			},
			expectedError: errUnexpected,
		},
	}
