...
func TestUserController_create(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			requestBody:          `{}`,
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"email":"failed on the 'required' tag","password":"failed on the 'required' tag","username":"failed on the 'required' tag"}}`,
		},
		{
			name:                 "Validation error: short password",
			requestBody:          `{"username":"john1967","password":"test","email":"john1967@gmail.com"}`,
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"password":"failed on the 'min' tag"}}`,
		},
		{
			name:                 "Validation error: invalid email address",
			requestBody:          `{"username":"john1967","password":"qwerty12345","email":"12345"}`,
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"email":"failed on the 'email' tag"}}`,
		},
		{
			...
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"birth_date":"failed on the 'datetime' tag"}}`,
		},
		{
...
func TestUserController_update(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			requestBody:          `{}`,
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"email":"failed on the 'required' tag","username":"failed on the 'required' tag"}}`,
		},
		{
			name:                 "Validation error: invalid email address",
...
func TestUserController_updatePassword(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			requestBody:          `{}`,
			expectedStatusCode:   http.StatusBadRequest,
			expectedResponseBody: `{"code":"CM0006","message":"validation error","data":{"current_password":"failed on the 'required' tag","new_password":"failed on the 'required' tag"}}`,
		},
		{
